...
| Drones as the sensing platform for remote enclosures and the piranha tank | Reach without cabling; one platform serves many enclosures; a flexible camera angle | Rotor noise and downwash next to venomous and nocturnal animals is a welfare question a vet would have to answer per enclosure (A7), and the answer is often no; flight permissions over a site open to the public with children; endurance gives minutes per sortie against the continuous baseline S1 needs, so anomalies between sorties are invisible; and the frames still have to be processed somewhere, which is this ADR's actual question | Welfare sign-off and regulation, for intermittent coverage of something fixed cameras already do continuously |
