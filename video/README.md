...
2. 0:30 Business-first: pain points → OKRs → the business case (parking binds first; the platform is a growth bet that pays back in years 4–6) → a phased roadmap (what we build when, what we buy)
