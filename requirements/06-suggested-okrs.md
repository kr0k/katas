...
| | 1.2 Returning share of households — pass or opt-in account — with ≥ 2 visits in 12 mo¹ | ~10% | 10% / 25% | 40% — model: ≈ 32%, growth dilutes the flywheel ([08 §3](../appendix/business-case-model.md#3-the-membership-flywheel)) | S4 |
| | 1.3 Family and season passes as share of admissions (visitor-days admitted on passes ÷ all admissions) | ~20% | 19% / 40% | ≥ 50% — model: ≈ 41% ([08 §2](../appendix/business-case-model.md#2-where-the-growth-comes-from)) | S4, S5 |
...
| | 5.4 Agent task success, and human-override rate on agent proposals | n/a | ≥ 70% success / override ≤ 40% | ≥ 85% / ≤ 25% | [Agents](../hld/ai-platform/agents.md) |
