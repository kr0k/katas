...
| [AI incident runbook](ai-incident-runbook.md) | Fall back, tell the owner, preserve the evidence, post-mortem — plus the two cases worth pre-deciding | SRE / AI platform | [ADR-0008](../adrs/ADR-0008-ai-evaluation-and-production-monitoring.md), [ADR-0013](../adrs/ADR-0013-role-agents-on-typed-tools.md), NFR-AGT-1 |
