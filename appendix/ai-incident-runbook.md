...
([ADR-0013](../adrs/ADR-0013-stakeholder-agents-on-typed-tools.md) §6), so the question is not whether the
...
([ADR-0013](../adrs/ADR-0013-stakeholder-agents-on-typed-tools.md) §1, NFR-RES-2).
