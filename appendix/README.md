...
| [AI incident runbook](ai-incident-runbook.md) | What counts as an AI incident, the four steps from falling back to re-entry, and two pre-decided cases | AI platform / SRE | [AI platform → model governance](../hld/ai-platform/README.md#model-governance), [ADR-0008](../adrs/ADR-0008-ai-evaluation-and-production-monitoring.md) |
