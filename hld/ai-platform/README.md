...
- **The two caches are what keep it there.** Without the daily FAQ cache and prompt caching of the session prefix, the same traffic costs ≈ €67,100 — outside the line. Same shape as the [ingestion counterfactual](../core/edge-and-connectivity.md#capacity-check-at-15000-visitorsday-by-traffic-class): the two designs differ by a factor, not a rounding.
