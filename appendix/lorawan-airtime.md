...
**Conclusion:** three gateways, ≈ 5% channel load each, worst-case device duty cycle ≈ 0.7% against the 1% regulatory limit. A device that drifts to SF11+ leaves LoRaWAN for PoE or halves its reporting rate.
